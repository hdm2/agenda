...
<body>
 ...
 <nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid">
   <div class="navbar-header">
    ...
    <a class="navbar-brand" href="#">Agenda Telefônica - Editar Contato</a>
   </div>
 ...
 <div id="main" class="container-fluid">
  ...
  <h3 class="page-header">Editar Contato</h3>
  
  <form action="index.html">
  	<div class="row">
  	  <div class="form-group col-md-4">
  	  	<label for="idInput">Id</label>
  	  	<input type="text" class="form-control" id="idInput" placeholder="Digite o id">
  	  </div>
	  <div class="form-group col-md-4">
  	  	<label for="nomeInput">Nome</label>
  	  	<input type="text" class="form-control" id="nomeInput" placeholder="Digite o nome">
  	  </div>
	  <div class="form-group col-md-4">
  	  	<label for="telefoneInput">Telefone</label>
  	  	<input type="text" class="form-control" id="telefoneInput" placeholder="Digite o telefone">
  	  </div>
	</div>
