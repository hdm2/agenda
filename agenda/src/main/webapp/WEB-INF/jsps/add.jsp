...
<body>
 ...
 <nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid">
   <div class="navbar-header">
    ...
    <a class="navbar-brand" href="#">Agenda Telefônica - Novo Contato</a>
   </div>
 ...
 <div id="main" class="container-fluid">
  ...
  <form data-bind="submit: validateAndSave, with: contato" data-toggle="validator">
  	<div class="row">
  	  <div class="form-group col-md-4">
  	  	<label for="nomeInput">Nome</label>
  	  	<input type="text" class="form-control" id="nomeInput" data-bind="value: nome" placeholder="Digite o nome">
  	  </div>
	  <div class="form-group col-md-4">
  	  	<label for="telefoneInput">Telefone</label>
  	  	<input type="text" class="form-control" id="telefoneInput" data-bind="value: telefone"  data-minlength="8" required placeholder="Digite o telefone">
...
//            	if (!$(form).validate()) return; 
                console.log("contato");
                console.log(self.contato);
                self.temp=JSON.stringify( { "nome": $('#nomeInput').val(), "telefone": $('#telefoneInput').val() } );
                self.temp=JSON.parse(self.temp);
                console.log("json");
                ...
                $.ajax({
                    ...
                    data: JSON.stringify( { "nome": $('#nomeInput').val(), "telefone": $('#telefoneInput').val() } ),
                    processData: false,
                    success: function( data, textStatus, jQxhr ){
                    	console.log("data postcontato");
                    	console.log(data);
                    	msg="";
                        $('#response pre').html( JSON.stringify( data ) );
                        if (data.status=="Done") {
                            msg="Inclusão de "+self.temp.nome+"-"+self.temp.telefone+" concluído com sucesso!";
                        }
                        else {
                        	msg="Inclusão não efetuada: "+data.data;
                        }
                        console.log(msg);
                        alert(msg);
                    ...
                    error: function( jqXhr, textStatus, errorThrown ){
                    	msg="Erro na inclusão do contato: "+self.temp.nome+"-"+self.temp.telefone;
                    	console.log(msg);
                    	alert(msg);
